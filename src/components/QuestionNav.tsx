...
export default function QuestionNav({
  ...
  return (
    <>
      ...
      >
        <List size={18} />
        <span className="absolute -top-1.5 -right-1.5 text-[10px] bg-indigo-600 text-white rounded-full w-4.5 h-4.5 flex items-center justify-center font-bold" style={{width:"18px",height:"18px"}}>
          {answers.size}
        </span>
      </button>
      ...
      {open && (
        ...
        >
          <div
            className="bg-white dark:bg-slate-900 rounded-t-xl sm:rounded-xl w-full sm:w-auto max-w-lg mx-0 sm:mx-4 max-h-[60vh] sm:max-h-[70vh] overflow-y-auto shadow-xl"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="sticky top-0 bg-white dark:bg-slate-900 px-5 py-3 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
